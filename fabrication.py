...
class Fabrication:
    ...
    def begin_generation(
        ...
        shared_corrections = resolve_shared_corrections(assembly_snapshot, corrections)
    ...
    def _cpl_row(
        ...
        try:
            ...
            source = (
                f"correction {match.correction.pattern!r}" if match else "no correction"
            )
            raise ValueError(
    ...
    @staticmethod
    def _check_corrections(corrections: tuple[Correction, ...]) -> None:
