...
from correction_data import Correction
...
def test_exact_shared_correction_details_and_copy(
    matching_snapshot: native.BoardVariantSnapshot,
) -> None:
    rule = Correction("R1", "90", (1e-9, -2e-9))
    correction = m.CorrectionState(rule.rotation, *rule.offset, "val", 239.999999998)
    ...
    for text in ("90", "1e-09", "-2e-09", "239.999999998", "val", "Shared"):
